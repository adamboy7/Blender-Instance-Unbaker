...
Exporting and re-importing an instanced object can destroy instance relationships, and while separating by loose pieces can re-construct individual objects, linked relations are lost resulting in bigger file sizes and lost scale/rotation. This addon helps reverse that: point it at a matching face on the canonical and the baked duplicate, and it spawns a correctly-placed linked instance in one click.
