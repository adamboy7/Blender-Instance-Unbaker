...
Blender's "Realize Instances" and similar bake operations destroy instance relationships, leaving you with hundreds of independent mesh copies. This addon reverses that: point it at a matching face on the canonical and the baked duplicate, and it spawns a correctly-placed linked instance in one click.
